...
SECRET_KEY = 'django-insecure-n)vb70^@!^(_h$v0os$f*re==u0j3n#x6a8y@u%qtw0qaaiw+$'
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # Ensure this is placed before other middleware.
